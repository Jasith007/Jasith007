...
<body class="bg-dark">
    <div class="container shadow-lg rounded">
        ...
        <form class=" mt-5 form-label row " action="contenido_usuario.php" method="POST">
            <input class="form-control p-2 mt-2 col" type="text" name="nombre_usuario" placeholder="Ingresa Usuario">
            <div></div>
            <input class="form-control mt-2 col" type="text" name="contrasena2" placeholder="Ingresa Contraseña">
            <div></div>

            <button class="fw-bold fst-italic btn btn-danger mt-4" type="submit">Login</button>
